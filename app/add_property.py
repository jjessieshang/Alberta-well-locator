...
class AddProperty(FlaskForm):
    ...
    Depth = StringField('Depth', [ InputRequired()])
...
@app.route('/add_property/<uwi>', methods=['GET', 'POST'])
def add_property(uwi):
    form1 = AddProperty()
    uwi = uwi
    if form1.validate_on_submit():
        ...
        message = f"The data for well {uwi} has been submitted."
        ...
        return render_template('add_property.html', form1=form1, uwi=uwi)